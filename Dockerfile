...
RUN curl -L https://repo1.maven.org/maven2/org/apache/hadoop/hadoop-common/3.3.6/hadoop-common-3.3.6.jar -o /opt/flink/lib/hadoop-common-3.3.6.jar && \
    ...
    ## Hive Flink Library
    curl -L https://repo1.maven.org/maven2/org/apache/flink/flink-sql-connector-hive-3.1.3_2.12/1.18.1/flink-sql-connector-hive-3.1.3_2.12-1.18.1.jar -o /opt/flink/lib/flink-sql-connector-hive-3.1.3_2.12-1.18.1.jar && \
    ## Hadoop AWS Classes
